...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Right controls pushed all the way to the right */
        .nav-right {
            display: flex;
            align-items: center;
            gap: 10px;
        ...
        /* Flash messages sit ABOVE page content, before any banner */
        .flash-zone {
            max-width: 1100px;
            margin: 0 auto;
            padding: 20px 24px 0;
        ...
        .btn-ghost:hover { background: var(--surface3); border-color: rgba(255,255,255,0.18); }
        ...
        /* Smaller button variant — still comfortable to click */
        ...
        /* Hide Alpine-controlled elements before JS loads */
        ...
        @media (max-width: 640px) {
            .top-nav {
                height: auto;
                flex-wrap: wrap;        /* allows nav-links to wrap to second row */
                padding: 0 16px;
                gap: 0;
                align-items: center;
            }
            ...
            /* Row 1: right controls on right */
            .nav-right {
                order: 2;
                margin-left: auto;      /* pushes right controls to far right */
                height: 56px;
                align-items: center;
            }

            /* Row 2: full-width scrollable link strip */
            .nav-links {
                order: 3;
                width: 100%;
                flex: none;
...
<body>
    ...
    {{-- Top Navigation: logo | nav-links | [auto gap] | nav-right --}}
    <nav class="top-nav">
    ...
    <div class="page-wrapper">
        ...
        {{-- Flash messages: rendered ABOVE any page-specific banners --}}
