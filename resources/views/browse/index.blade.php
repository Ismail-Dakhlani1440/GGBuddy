...
<div style="display:flex;flex-direction:column;gap:24px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:16px;">
        ...
        <a href="{{ route('browse.show', $ebuddy) }}" style="text-decoration:none;display:block;" class="card" style="overflow:hidden;">
            <div class="card" style="overflow:hidden;display:flex;flex-direction:column;transition:transform 0.2s,border-color 0.2s;" onmouseover="this.style.transform='translateY(-3px)';this.style.borderColor='rgba(124,58,237,0.35)'" onmouseout="this.style.transform='translateY(0)';this.style.borderColor='var(--border)'">
                {{-- Banner --}}
                ...
                {{-- Avatar --}}
                <div style="padding:0 20px;margin-top:-28px;margin-bottom:14px;">
                ...
                <div style="padding:0 20px 20px;">
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
                        ...
                        <span class="badge badge-purple" style="font-size:9px;">Pro</span>
                    </div>
                    ...
                    @endif
                    {{-- Price from --}}
                    @if($ebuddy->services->count())
                    <div style="display:flex;align-items:center;justify-content:space-between;">
                        <span style="font-size:11px;color:var(--text-2);">From</span>
                        <span style="font-size:15px;font-weight:800;color:var(--text);">${{ number_format($ebuddy->services->min('price'), 0) }}<span style="font-size:11px;font-weight:500;color:var(--text-2);">/hr</span></span>
                    </div>
                    @else
